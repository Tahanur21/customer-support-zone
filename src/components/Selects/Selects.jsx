  ...
  return (
    <div className="mt-10 col-span-1">
      ...
      <div>
        ...
        <div className="mt-6 space-y-4 p-3 rounded-2xl">
          {selects.map((select, idx) => (
            <div
              key={idx}
              className="bg-base-100 shadow-lg p-4 rounded space-y-4"
            >
              <h1 className="text-xl font-semibold text-[#020406]">
                {select.title}....
              </h1>
              <button
                onClick={() => {
                ...
                className="py-6 btn bg-green-600 hover:bg-green-700 text-white text-lg w-full"
              >
                Complete
              </button>
            </div>
      ...
      <div className="mt-10 ">
        ...
        <div className="space-y-2 mt-5 p-3 rounded-2xl">
          {complete.map((completed, idx) => (
            <div className="bg-[#E0E7FF] shadow-lg p-4 rounded" key={idx}>
